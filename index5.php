...
?>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1>Setting</h1>
            <hr>
            <nav class="navbar navbar-expand-lg navbar-light bg-light hover">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="#">payment</a>
            ...
            <div >
         <pre class="detail-container">
          <form method="post" action="">          firstname                                       lastname
           <input type="text" name="fname" placeholder="fname">    <input type="text" name="lname" placeholder="lname">

           Email address
           <input type="email" name="email" placeholder="enter email address" required="required" style="width: 500px;">

           Phone number                                  Birthday
           <input type="digit" name="num" placeholder="(+91)**********" required="number" >       <input type="date" name="date1">
